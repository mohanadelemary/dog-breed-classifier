...
def get_input_args():
    ...
    parser.add_argument('--arch', type = str, default= 'vgg', help = 'CNN Model Architecture Default')
    parser.add_argument('--dogfile', type = str, default= 'dognames.txt', help = 'Default Text File with Dog Names')
